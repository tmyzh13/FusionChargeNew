...
public class UserPhotoChooseAdapter {
}
/*
public class UserPhotoChooseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private com.lzy.imagepicker.adapter.ImageRecyclerAdapter.OnImageItemClickListener listener;   //图片被点击的监听

    public void setOnImageItemClickListener(com.lzy.imagepicker.adapter.ImageRecyclerAdapter.OnImageItemClickListener listener) {
...
/**
    ...
    public UserPhotoChooseAdapter(Activity activity, ArrayList<ImageItem> images) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_CAMERA){
            return new com.lzy.imagepicker.adapter.ImageRecyclerAdapter.CameraViewHolder(mInflater.inflate(com.lzy.imagepicker.R.layout.adapter_camera_item,parent,false));
        }
        return new com.lzy.imagepicker.adapter.ImageRecyclerAdapter.ImageViewHolder(mInflater.inflate(com.lzy.imagepicker.R.layout.adapter_image_list_item,parent,false));
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof com.lzy.imagepicker.adapter.ImageRecyclerAdapter.CameraViewHolder){
            ((com.lzy.imagepicker.adapter.ImageRecyclerAdapter.CameraViewHolder)holder).bindCamera();
        }else if (holder instanceof com.lzy.imagepicker.adapter.ImageRecyclerAdapter.ImageViewHolder){
            ((com.lzy.imagepicker.adapter.ImageRecyclerAdapter.ImageViewHolder)holder).bind(position);
        }
    }
