...
public class InvoiceConsumeAdapter extends BaseAdapter {
    ...
    public InvoiceConsumeAdapter(Context context, List<InvoiceConsumeBean> data) {
        this.data = data;
        this.context = context;
        inflater = LayoutInflater.from(context);
    }

    public void setData(List<InvoiceConsumeBean> list){
        data = list;
...
//            holder.sort = (TextView) view.findViewById(R.id.consume_sort);
        ...
        holder.adress.setText(data.get(i).chargerAddr);
//        holder.sort.setText(data.get(i).type);
        holder.money.setText(getSpanString(data.get(i).totalFee+""));
        return view;
    }
